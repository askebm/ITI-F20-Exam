...
\begin{frame}[fragile]
	...
	\begin{figure}[h]
	\begin{center}
		\begin{tikzpicture}[scale=1, transform shape, every node/.style={draw,circle,minimum width=2.2cm}]
		\graph[spring layout,node distance=3cm,horizontal=Database to Controller]{
			Model -> {
				Database,
				Controller -> {
					View,
